...
import { Info, Settings2, Armchair } from "lucide-react";
              ...
              return (
                <div key={key} className="flex items-center justify-between gap-4 text-xs font-sans">
                  ...
                  <input
                    ...
                    className="flex-1 h-1.5 bg-slate-100 rounded cursor-pointer accent-bungeco-orange"
                  />
